...
SCRIPT_REF="${PRISM_SCRIPT_REF:-v1.5.25}"
BINARY_NAME="prism-agent"
INSTALL_DIR="/usr/local/bin"
SERVICE_NAME="prism-agent"
SCRIPT_URL="https://raw.githubusercontent.com/${SCRIPT_REPO}/refs/tags/${SCRIPT_REF}/agent_install.sh"
TRANSPORT_URL="https://raw.githubusercontent.com/${SCRIPT_REPO}/refs/tags/${SCRIPT_REF}/prism_transport.sh"
CUSTOM_IP=""
