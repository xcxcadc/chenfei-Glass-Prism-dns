...
```bash
curl -sL https://raw.githubusercontent.com/xcxcadc/chenfei-Glass-Prism-dns/refs/tags/v1.5.25/agent_install.sh | bash -s -- --master <Controller_URL> --secret <Node_Secret>
```
