...
```bash
curl -fsSL https://raw.githubusercontent.com/xcxcadc/chenfei-Glass-Prism-dns/refs/tags/v1.5.27/agent_install.sh | bash -s -- --version v1.3 --master <面板地址> --secret <节点密钥>
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/xcxcadc/chenfei-Glass-Prism-dns/refs/tags/v1.5.27/agent_install.sh | bash -s -- --version v1.2.1 --master <面板地址> --secret <节点密钥>
```
